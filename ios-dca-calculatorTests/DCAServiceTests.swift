...
class ios_dca_calculatorTests: XCTestCase {
  ...
  func testResult_givenLosingAssetAndDCAIsUsed_expectNegativeGains() {
    ...
    // Jan: $5000 / 170 = 29.4119 shares
    // Feb: $1500 / 160 = 13.6363 shares
    // March: $1500 / 150 = 12.5 shares
    // April: $1500 / 140 = 11.5384 shares
    // May: $1500 / 130 = 10.7142 shares
    // June: $1500 / 120 = 10 shares
    ...
    //Yield = gains / investment amount: -3310 / 12500 = -0.2648
  ...
  func testResult_givenLosingAssetAndDCAIsNotUsed_expectNegativeGains() {
    ...
    // Yield = gains / investment amount: -1333.33 / 5000 = -0.26666
